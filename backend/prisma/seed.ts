...
async function main() {
  ...
  const usersData = [
    ...
    { email: "rox@fmb.com",              name: "Rox",                         role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Centro LYFRGL" },
    { email: "fer@fmb.com",              name: "Fer",                         role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Norte LYFRGL" },
    { email: "vite@fmb.com",             name: "Vite",                        role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Poniente LYFRGL" },
    { email: "yair@fmb.com",             name: "Yair",                        role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Centro LYFRGL" },
    { email: "luz@fmb.com",              name: "Luz",                         role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Norte LYFRGL" },
    { email: "darlyn@fmb.com",           name: "Darlyn",                      role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Poniente LYFRGL" },
    { email: "gael@fmb.com",             name: "Gael",                        role: "CAJERO",  password: defaultPasswordHash, pin: defaultPin, branchName: "Sucursal Centro LYFRGL" },
  ];
