...
export default function CloseCashModal({
  ...
  return (
    <PosModal
      ...
      subtitle="Confirma los totales antes de cerrar tu turno."
      icon={<Lock size={24} />}
      iconColor="#dc2626"
      size="md"
      footer={renderFooter()}
    >
      <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "14px" }}>
        ...
        <div style={summaryRow}>
          ...
          <span style={{ fontWeight: "600", color: "#dc2626" }}>-${sessionStats?.cashOut?.toFixed(2) || "0.00"}</span>
        </div>
        <div style={summaryRow}>
        ...
        <div style={{ ...summaryRow, borderBottom: "1px dashed #cbd5e1", paddingBottom: "10px" }}>
          ...
          <span style={{ fontWeight: "800", color: "var(--accent-strong)" }}>${sessionStats?.expectedAmount?.toFixed(2) || "0.00"}</span>
        </div>
