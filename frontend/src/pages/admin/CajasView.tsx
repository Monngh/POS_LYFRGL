...
const CajasView: React.FC<ViewProps> = ({ branchId, refreshToken }) => {
  ...
  const printCashReport = () => {
    ...
    const diffColor = d.difference === null ? "var(--text-faint)" : d.difference >= 0 ? "#15803d" : "#b91c1c";
    const diffStr =
      d.difference !== null
  ...
  const diffColor = (d: number | null) =>
    d === null ? "var(--text-faint)" : d < 0 ? "#b91c1c" : d > 0 ? "#15803d" : "var(--text-secondary)";
              ...
              {!loading &&
                ...
                rows.map((s) => (
                  <tr
                    ...
                    style={{ cursor: "pointer", backgroundColor: hoveredRow === s.id ? "var(--surface-2)" : "transparent" }}
                  >
            ...
            <div style={ui.modalBody}>
              ...
              {!detailLoading && !detailError && selectedDetail && (
                <>
                  ...
                  <div style={{ display: "flex", justifyContent: "flex-end", fontSize: 13, fontWeight: 700, color: "var(--text)", paddingTop: 6, borderTop: "1px solid var(--surface-3)" }}>
            ...
            <div style={ui.modalBody}>
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: 8, marginTop: 20 }}>
                ...
                <button
                  style={{
                    ...ui.primaryBtn,
                    backgroundColor: forceLoading || !forceReason.trim() ? "var(--text-faint)" : "#b91c1c",
